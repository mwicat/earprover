...
function hide_timber_flash() {    // Called from Flash - this isn't part of the API.
	...
	document.getElementById(timber_flash_container).style.width = "1px";
	document.getElementById(timber_flash_container).style.height = "1px";
	document.getElementById(timber_flash_container).style.border = "0px";
	document.getElementById(timber_flash_container).style.margin = "0px";
	document.getElementById(timber_flash_container).style.padding = "0px";
    }
}
